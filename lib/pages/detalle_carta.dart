                  ...
                  Container(
                     ...
                     child:Column(
                      ...
                      children:[
                          ...
                          const SizedBox(height:25),
                          info_carta(size: size,label:"Carta",texto:cartaProvider.selectCartaDTO!.type??"",url:'assets/carta.PNG'),
                          const SizedBox(height:25),
                          info_carta(size: size,label:"Atributo",texto:cartaProvider.selectCartaDTO!.attribute??"",url:null),
                          const SizedBox(height:25),
                          info_carta(size: size,label:"Enlace",texto:cartaProvider.selectCartaDTO!.linkval??"",url:null),
                          const SizedBox(height:25),
                          info_carta(size: size,label:"Tipo",texto:cartaProvider.selectCartaDTO!.humanReadableCardType??"",url:null),
                          const SizedBox(height:25),
                          info_carta(size: size,label:"ATK",texto:cartaProvider.selectCartaDTO!.atk??"",url:'assets/ataque.png'),
                          const SizedBox(height:20),
                          info_carta(size: size,label:"Nivel",texto:cartaProvider.selectCartaDTO!.level??"",url:null),
                     ],),
                  )
                ]
              ))
